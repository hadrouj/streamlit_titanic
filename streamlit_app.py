...
if page=="Exploration":
    ...
    st.write("Ici, nous allons construire un modèle de classification pour prédire la survie des passagers du Titanic.")
    st.write("Nous allons utiliser un modèle de régression logistique pour cette tâche.")
